...
function myFunction() {
  ...
  var myFilterData = users.filter(function(value) {

            if (value.name == document.getElementById("myInput").value || value.id == document.getElementById("myInput").value ){
